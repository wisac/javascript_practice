/* Javascript has similar operators like the ones in C++/java
    ...
    */
    ...
    /* Soecial values Nan, null and undefined are all falsy values*/
...
/*THE OPTIONAL CHAINING OPERATOR
    In order to nested members of a class, you have to check whether the member is present in the hierachy in order to avoid runtime error.
